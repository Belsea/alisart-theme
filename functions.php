...
function alisart_theme_setup() {
	...
	register_nav_menus( array(
		'primary'			=>  __('Primary Pages Navigation', 'alisart_theme'),
		'primary+secondary'	=>	__('Portrait Navigation', 'alisart_theme'),
		'header-socials'	=>	__('Header Socials Navigation', 'alisart_theme'),
		'footer-socials'	=>	__('Footer Socials Navigation', 'alisart_theme'),
		'footer-policies'	=>	__('Footer Policies Links', ' alisart_theme')
	) );
	...
	# 512 width existing <- dov'è finito? segna un medium_large da 768
	# AH-DIòCANE
